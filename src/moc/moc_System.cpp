...
static const char qt_meta_stringdata_System[] = {
    "System\0\0updateNextCoord(Vector3D)\0"
    "updateMDBox(Matrix3D)\0"
};
...
void System::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateNextCoord((*reinterpret_cast< Vector3D(*)>(_a[1]))); break;
        case 1: _t->updateMDBox((*reinterpret_cast< Matrix3D(*)>(_a[1]))); break;
        default: ;
        }
    }
}
